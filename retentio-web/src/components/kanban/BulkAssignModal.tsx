...
export function BulkAssignModal({ open, onOpenChange, selectedIds, onSuccess }: BulkAssignModalProps) {
  ...
  const handleAssign = () => {
    if (!targetSdr || selectedIds.length === 0) return;
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="py-4 space-y-4">
          ...
          {assignMutation.isError && (
            <p className="text-xs text-red-500 bg-red-500/10 p-2 rounded-md">
              Erro na atribuição. Possível limite excedido (Max 100 ativos por SDR).
            </p>
          )}
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!targetSdr || assignMutation.isPending || assignMutation.isSuccess}
